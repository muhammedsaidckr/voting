                        ...
                        <button
                            ...
                            <ul
                                ...
                                class="absolute w-44 text-left font-semibold bg-white
                                     shadow-dialog z-10 rounded-xl py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0">
                                <li><a href="#"
        ...
        <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
            <div class="relative" x-data="{isOpen: false}">
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false"
                    class="absolute z-10 w-64 md:w-104 text-left font-semibold bg-white shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            <button type="button"
                                    class="flex items-center justify-center w-full md:w-1/2 h-11 text-sm bg-blue text-white
                             font-semibold rounded-xl border border-blue hover:bg-blue-hover
                             transition duration-150 ease-in px-6 py-3">
                                Post Comment
                            </button>
            ...
            <div class="relative" x-data="{ isOpen: false }">
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false"
                    class="absolute z-10 w-64 md:w-76 text-left font-semibold bg-white shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            px-3">
                                ...
                                <ul
                                    ...
                                    @click.away="isOpen = false"
                                    @keydown.escape.window="isOpen = false"
                                    class="absolute w-44 font-semibold text-sm text-left bg-white shadow-dialog rounded-xl py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0">
                                    <li><a href="#"
                                           class="hover:bg-gray-100 transition duration-150 block ease-in px-5 py-3">Mark
                                            as
                                            Spam</a></li>
