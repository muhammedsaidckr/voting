...
<header class="flex items-center justify-between px-8 py-4">
    ...
    <div class="flex items-center">
        ...
        <a href="#">
            <img src="https://en.gravatar.com/avatar/000000000000000000?d=mp" alt="" class="h-10 w-10 rounded-full">
        </a>
    </div>
...
<main class="container mx-auto max-w-custom flex">
    <div class="w-70 mr-5">
        <div
            class="bg-white border-2 rounded-xl mt-16"
            style="
        ...
        >
            <div class="text-center px-6 py-2 pt-6">
                ...
                <p class="text-xs mt-4">Let us know what would you like and we'll take look over!</p>
            </div>
            <form action="#" method="POST" class="space-y-4 px-4 py-6">
                ...
                <div>
                    <select name="category_add" id="category-add" class="w-full rounded-xl bg-gray-100 border-none
                     text-sm px-4 py-2">
                ...
                <div>
                    <textarea name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 border-none rounded-xl
                     placeholder-gray-900 text-sm px-4 py-2" placeholder="Describe your idea"></textarea>
                </div>
